...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_pages_blocks_image_and_text_image_position" AS ENUM('left', 'right');
  ...
  CREATE TABLE "pages_blocks_image_and_text" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	...
  	"content" jsonb,
  	"image_position" "enum_pages_blocks_image_and_text_image_position" DEFAULT 'right',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"logo_id" integer,
  	"company_name" varchar DEFAULT 'South West Planning Consultancy' NOT NULL,
  	"company_tagline" varchar DEFAULT 'Planning Consultants Southwest',
  	"address" varchar DEFAULT 'The Generator Hub, The Gallery, Kings Wharf, The Quay, Exeter, Devon, EX2 4AN',
  	"registered_office" varchar,
  	"email" varchar DEFAULT 'info@southwestplanningconsultancy.co.uk',
  	"registration_number" varchar DEFAULT '13398455',
  	"social_links_instagram" varchar,
  	"social_links_twitter" varchar,
  	"social_links_linkedin" varchar,
  	"social_links_facebook" varchar,
  	"footer_text" varchar DEFAULT '© South West Planning Consultancy Ltd. Registered in England and Wales.',
  ...
  ALTER TABLE "pages_blocks_image_and_text" ADD CONSTRAINT "pages_blocks_image_and_text_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "pages_blocks_image_and_text" ADD CONSTRAINT "pages_blocks_image_and_text_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_image_and_text_order_idx" ON "pages_blocks_image_and_text" USING btree ("_order");
  CREATE INDEX "pages_blocks_image_and_text_parent_id_idx" ON "pages_blocks_image_and_text" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_image_and_text_path_idx" ON "pages_blocks_image_and_text" USING btree ("_path");
  CREATE INDEX "pages_blocks_image_and_text_image_idx" ON "pages_blocks_image_and_text" USING btree ("image_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_image_and_text" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_blocks_image_and_text_image_position";`)
}
