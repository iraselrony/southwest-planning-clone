// Privacy & cookie policy page. Renders the mirrored HTML with optional
// Payload-backed content injected into the policy-body zone.
...
const SOURCE = resolveMirrorPath("privacy-cookie-policy.html");
