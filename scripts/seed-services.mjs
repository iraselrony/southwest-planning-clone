...
const SERVICES = [
	...
	{ slug: "renewables",                 name: "Renewables Planning",                   subtitle: "09", displayOrder: 9,  description: "Planning advice for solar farms, wind turbines, anaerobic digestion, battery storage, and grid connection applications." },
